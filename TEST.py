...
crc16_tab = [0x0, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7,
...
def CRC16_cal(ptr, len_, crc_init=0):
    crc = crc_init
    for i in range(len_):
        temp = (crc >> 8) & 0xff
        crc = ((crc << 8) ^ crc16_tab[ptr[i] ^ temp]) & 0xffff
    return crc
...
def rotate(x, y, t):
    ...
    calculated_checksum = CRC16_cal(data_to_checksum, len(data_to_checksum))
