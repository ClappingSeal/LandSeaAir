...
class LockingEnv(gym.Env):
    ...
    def __init__(self):
        ...
        # 초기 위치
        x_c = 16* (2 * np.random.random() - 1)
        y_c = 12* (2 * np.random.random() - 1)
    ...
    def step(self, action):
        ...
        self.agent_pos[0] = np.clip(self.agent_pos[0], -16, 16)
        self.agent_pos[1] = np.clip(self.agent_pos[1], -12, 12)
        done = False
        # reward
        ...
        return self.agent_pos, reward_total, done, info
