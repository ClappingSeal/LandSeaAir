    ...
    if start_command == 's':
        ...
        try:
            while True:
                ...
                sending_data = [sending_array[0], sending_array[1], sending_array[2],
                                sending_array[3]]  # Prepare data for sending
                ...
                if w_scaled > 0 and h_scaled > 0:
                    cv2.rectangle(resized_frame, (x_scaled, y_scaled), (x_scaled + w_scaled, y_scaled + h_scaled),
                                  (0, 255, 0), 2)
                    if label_idx >= 0:
                        ...
                        cv2.rectangle(resized_frame, (text_x, text_y + 5), (text_x + text_w, text_y - text_h - 5),
                                      (0, 255, 0), cv2.FILLED)
                        cv2.putText(resized_frame, label_text, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 0.6,
                                    (0, 0, 0), 2)
